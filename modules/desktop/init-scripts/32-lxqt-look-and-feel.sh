...
mkdir -p "/home/${DESKTOP_USERNAME}/.config/openbox"
cat << EOF > "/home/${DESKTOP_USERNAME}/.config/openbox/lxqt-rc.xml"
<?xml version="1.0" encoding="UTF-8"?>
<!-- Do not edit this file, it will be overwritten on install.
        Copy the file to /home/${DESKTOP_USERNAME}/.config/openbox/lxqt-rc.xml instead. -->
<openbox_config xmlns="http://openbox.org/3.4/rc" xmlns:xi="http://www.w3.org/2001/XInclude">
  ...
  <theme>
    <name>Lubuntu Round</name>
    <titleLayout>NLMSC</titleLayout>
    <!--
  ...
  <menu>
    ...
    <!-- default menu file (or custom one in /home/${DESKTOP_USERNAME}/.config/openbox/) -->
    <file>menu.xml</file>

...
Uses HashiCorp's Packer tool and Chen-Han Hsiao's excellent [template library](https://github.com/chenhan1218/packer-desktop/tree/desktop/packer_templates/ubuntu) in order to install the Lubuntu LXQt Desktop on top of the official `ubuntu-19.10-server-amd64.iso`. Finally, the created Virtualbox VM is exported and uploaded to Vagrant Cloud as https://jafudi.net/vagrant-box.
